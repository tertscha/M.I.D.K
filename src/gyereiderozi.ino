...
void goForward() {
  ...
  //delay(200);
  //MiniR4.M3.setSpeed(minspeed);
  //MiniR4.M4.setSpeed(minspeed);
  MiniR4.OLED.clearDisplay();
  MiniR4.OLED.setCursor(10, 0);
...
void setup() {
  ...
  MiniR4.OLED.print("Webszerver elindult.");
  MiniR4.OLED.display();
  delay(1000);
  MiniR4.OLED.clearDisplay();
  MiniR4.OLED.setCursor(20, 0);
...
void sendPage(WiFiClient &client) {
  ...
  client.println("<p>");
  client.println("<a href='/comehere'><button>Gyere ide</button></a>");
  client.println("<a href='/turnaround'><button>Fordulj</button></a>");
  client.println("</p>");
...
void loop() {
  ...
  if (request.indexOf("GET /forward") >= 0) {
    ...
    stopRobot();
  } else if (request.indexOf("GET /comehere") >= 0) {
    comehere();
  } else if (request.indexOf("GET /turnaround") >= 0) {
    turnaround();    
  }
